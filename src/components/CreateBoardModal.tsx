...
export function CreateBoardModal({ onClose, onCreate }: CreateBoardModalProps): React.ReactElement {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-gray-800 rounded-lg w-full max-w-md border border-gray-700">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="mb-4">
            <label htmlFor="boardName" className="block text-sm font-medium text-gray-200 mb-2">
              Board Name
            </label>
            <input
              id="boardName"
